...
// Complete Indian FnO Database (LIVE Official NSE/BSE Market Rates)
const DEFAULT_INSTRUMENTS = [
  { id: 'nifty', name: 'NIFTY 50', symbol: 'NSE:NIFTY', tvSymbol: 'NSE:NIFTY', etfSymbol: 'NSE:NIFTYBEES', officialSymbol: 'NSE:NIFTY', yfSymbol: '^NSEI', category: 'Index', basePrice: 23373.60, lotSize: 25, strikeStep: 50, change: '+0.12%', isPositive: true, dayHigh: 23410.75, dayLow: 23314.80 },
  { id: 'banknifty', name: 'BANK NIFTY', symbol: 'NSE:BANKNIFTY', tvSymbol: 'NSE:BANKNIFTY', etfSymbol: 'NSE:BANKBEES', officialSymbol: 'NSE:BANKNIFTY', yfSymbol: '^NSEBANK', category: 'Index', basePrice: 56385.30, lotSize: 15, strikeStep: 100, change: '+0.05%', isPositive: true, dayHigh: 56510.95, dayLow: 56269.55 },
  { id: 'sensex', name: 'BSE SENSEX', symbol: 'BSE:SENSEX', tvSymbol: 'BSE:SENSEX', etfSymbol: 'BSE:SENSEX', officialSymbol: 'BSE:SENSEX', yfSymbol: '^BSESN', category: 'Index', basePrice: 74683.67, lotSize: 10, strikeStep: 100, change: '+0.52%', isPositive: true, dayHigh: 74787.26, dayLow: 74454.18 },
  { id: 'finnifty', name: 'FIN NIFTY', symbol: 'NSE:FINNIFTY', tvSymbol: 'NSE:FINNIFTY', etfSymbol: 'NSE:NIFTYBEES', officialSymbol: 'NSE:FINNIFTY', yfSymbol: 'NIFTY_FIN_SERVICE.NS', category: 'Index', basePrice: 25514.65, lotSize: 25, strikeStep: 50, change: '+0.02%', isPositive: true, dayHigh: 25592.75, dayLow: 25454.65 },
  { id: 'reliance', name: 'RELIANCE', symbol: 'NSE:RELIANCE', tvSymbol: 'NSE:RELIANCE', etfSymbol: 'NSE:RELIANCE', officialSymbol: 'NSE:RELIANCE', yfSymbol: 'RELIANCE.NS', category: 'Stock', basePrice: 1236.70, lotSize: 250, strikeStep: 20, change: '+0.84%', isPositive: true, dayHigh: 1244.40, dayLow: 1234.10 },
  { id: 'hdfcbank', name: 'HDFC BANK', symbol: 'NSE:HDFCBANK', tvSymbol: 'NSE:HDFCBANK', etfSymbol: 'NSE:HDFCBANK', officialSymbol: 'NSE:HDFCBANK', yfSymbol: 'HDFCBANK.NS', category: 'Stock', basePrice: 733.50, lotSize: 550, strikeStep: 10, change: '+0.34%', isPositive: true, dayHigh: 738.30, dayLow: 729.05 },
  { id: 'icicibank', name: 'ICICI BANK', symbol: 'NSE:ICICIBANK', tvSymbol: 'NSE:ICICIBANK', etfSymbol: 'NSE:ICICIBANK', officialSymbol: 'NSE:ICICIBANK', yfSymbol: 'ICICIBANK.NS', category: 'Stock', basePrice: 1343.60, lotSize: 700, strikeStep: 10, change: '+0.35%', isPositive: true, dayHigh: 1352.00, dayLow: 1343.00 },
  { id: 'tcs', name: 'TCS', symbol: 'NSE:TCS', tvSymbol: 'NSE:TCS', etfSymbol: 'NSE:TCS', officialSymbol: 'NSE:TCS', yfSymbol: 'TCS.NS', category: 'Stock', basePrice: 2115.00, lotSize: 175, strikeStep: 50, change: '+0.48%', isPositive: true, dayHigh: 2124.80, dayLow: 2075.30 },
  { id: 'infy', name: 'INFOSYS', symbol: 'NSE:INFY', tvSymbol: 'NSE:INFY', etfSymbol: 'NSE:INFY', officialSymbol: 'NSE:INFY', yfSymbol: 'INFY.NS', category: 'Stock', basePrice: 1033.60, lotSize: 400, strikeStep: 20, change: '-1.69%', isPositive: false, dayHigh: 1044.50, dayLow: 1030.30 },
  { id: 'sbin', name: 'SBI (SBIN)', symbol: 'NSE:SBIN', tvSymbol: 'NSE:SBIN', etfSymbol: 'NSE:SBIN', officialSymbol: 'NSE:SBIN', yfSymbol: 'SBIN.NS', category: 'Stock', basePrice: 994.30, lotSize: 1500, strikeStep: 5, change: '-0.19%', isPositive: false, dayHigh: 995.00, dayLow: 989.10 },
  { id: 'bajfinance', name: 'BAJAJ FINANCE', symbol: 'NSE:BAJFINANCE', tvSymbol: 'NSE:BAJFINANCE', etfSymbol: 'NSE:BAJFINANCE', officialSymbol: 'NSE:BAJFINANCE', yfSymbol: 'BAJFINANCE.NS', category: 'Stock', basePrice: 1031.40, lotSize: 125, strikeStep: 50, change: '-0.86%', isPositive: false, dayHigh: 1037.70, dayLow: 1026.30 },
  { id: 'bhartiartl', name: 'BHARTI AIRTEL', symbol: 'NSE:BHARTIARTL', tvSymbol: 'NSE:BHARTIARTL', etfSymbol: 'NSE:BHARTIARTL', officialSymbol: 'NSE:BHARTIARTL', yfSymbol: 'BHARTIARTL.NS', category: 'Stock', basePrice: 1843.00, lotSize: 475, strikeStep: 10, change: '-2.66%', isPositive: false, dayHigh: 1854.80, dayLow: 1839.50 }
];
