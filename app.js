...
const DEFAULT_INSTRUMENTS = [
  { id: 'nifty', name: 'NIFTY 50', symbol: 'NSE:NIFTY', tvSymbol: 'NSE:NIFTY', etfSymbol: 'NSE:NIFTYBEES', officialSymbol: 'NSE:NIFTY', yfSymbol: '^NSEI', category: 'Index', basePrice: 23152.10, lotSize: 75, strikeStep: 50, change: '+0.39%', isPositive: true, dayHigh: 23162.70, dayLow: 23020.95, iv: 0.135 },
  { id: 'banknifty', name: 'BANK NIFTY', symbol: 'NSE:BANKNIFTY', tvSymbol: 'NSE:BANKNIFTY', etfSymbol: 'NSE:BANKBEES', officialSymbol: 'NSE:BANKNIFTY', yfSymbol: '^NSEBANK', category: 'Index', basePrice: 55718.00, lotSize: 30, strikeStep: 100, change: '+0.50%', isPositive: true, dayHigh: 55762.60, dayLow: 55373.75, iv: 0.170 },
  { id: 'sensex', name: 'BSE SENSEX', symbol: 'BSE:SENSEX', tvSymbol: 'BSE:SENSEX', etfSymbol: 'BSE:SENSEX', officialSymbol: 'BSE:SENSEX', yfSymbol: '^BSESN', category: 'Index', basePrice: 73953.64, lotSize: 20, strikeStep: 100, change: '+0.51%', isPositive: true, dayHigh: 74020.00, dayLow: 73477.77, iv: 0.130 },
  { id: 'finnifty', name: 'FIN NIFTY', symbol: 'NSE:FINNIFTY', tvSymbol: 'NSE:FINNIFTY', etfSymbol: 'NSE:NIFTYBEES', officialSymbol: 'NSE:FINNIFTY', yfSymbol: 'NIFTY_FIN_SERVICE.NS', category: 'Index', basePrice: 25086.95, lotSize: 65, strikeStep: 50, change: '+0.53%', isPositive: true, dayHigh: 25124.00, dayLow: 24925.75, iv: 0.140 },
  { id: 'reliance', name: 'RELIANCE', symbol: 'NSE:RELIANCE', tvSymbol: 'NSE:RELIANCE', etfSymbol: 'NSE:RELIANCE', officialSymbol: 'NSE:RELIANCE', yfSymbol: 'RELIANCE.NS', category: 'Stock', basePrice: 1223.10, lotSize: 500, strikeStep: 20, change: '+0.32%', isPositive: true, dayHigh: 1225.70, dayLow: 1210.50, iv: 0.200 },
  { id: 'hdfcbank', name: 'HDFC BANK', symbol: 'NSE:HDFCBANK', tvSymbol: 'NSE:HDFCBANK', etfSymbol: 'NSE:HDFCBANK', officialSymbol: 'NSE:HDFCBANK', yfSymbol: 'HDFCBANK.NS', category: 'Stock', basePrice: 737.40, lotSize: 550, strikeStep: 10, change: '+1.17%', isPositive: true, dayHigh: 738.40, dayLow: 723.00, iv: 0.220 },
  { id: 'icicibank', name: 'ICICI BANK', symbol: 'NSE:ICICIBANK', tvSymbol: 'NSE:ICICIBANK', etfSymbol: 'NSE:ICICIBANK', officialSymbol: 'NSE:ICICIBANK', yfSymbol: 'ICICIBANK.NS', category: 'Stock', basePrice: 1325.10, lotSize: 700, strikeStep: 10, change: '-0.70%', isPositive: false, dayHigh: 1340.80, dayLow: 1324.00, iv: 0.210 },
  { id: 'tcs', name: 'TCS', symbol: 'NSE:TCS', tvSymbol: 'NSE:TCS', etfSymbol: 'NSE:TCS', officialSymbol: 'NSE:TCS', yfSymbol: 'TCS.NS', category: 'Stock', basePrice: 2081.90, lotSize: 225, strikeStep: 50, change: '-0.24%', isPositive: false, dayHigh: 2090.20, dayLow: 2038.10, iv: 0.220 },
  { id: 'infy', name: 'INFOSYS', symbol: 'NSE:INFY', tvSymbol: 'NSE:INFY', etfSymbol: 'NSE:INFY', officialSymbol: 'NSE:INFY', yfSymbol: 'INFY.NS', category: 'Stock', basePrice: 997.60, lotSize: 400, strikeStep: 20, change: '-1.67%', isPositive: false, dayHigh: 1004.20, dayLow: 991.60, iv: 0.230 },
  { id: 'sbin', name: 'SBI (SBIN)', symbol: 'NSE:SBIN', tvSymbol: 'NSE:SBIN', etfSymbol: 'NSE:SBIN', officialSymbol: 'NSE:SBIN', yfSymbol: 'SBIN.NS', category: 'Stock', basePrice: 982.70, lotSize: 750, strikeStep: 5, change: '+0.43%', isPositive: true, dayHigh: 985.70, dayLow: 977.00, iv: 0.240 },
  { id: 'bajfinance', name: 'BAJAJ FINANCE', symbol: 'NSE:BAJFINANCE', tvSymbol: 'NSE:BAJFINANCE', etfSymbol: 'NSE:BAJFINANCE', officialSymbol: 'NSE:BAJFINANCE', yfSymbol: 'BAJFINANCE.NS', category: 'Stock', basePrice: 993.30, lotSize: 750, strikeStep: 50, change: '+1.15%', isPositive: true, dayHigh: 995.00, dayLow: 980.20, iv: 0.260 },
  { id: 'bhartiartl', name: 'BHARTI AIRTEL', symbol: 'NSE:BHARTIARTL', tvSymbol: 'NSE:BHARTIARTL', etfSymbol: 'NSE:BHARTIARTL', officialSymbol: 'NSE:BHARTIARTL', yfSymbol: 'BHARTIARTL.NS', category: 'Stock', basePrice: 1792.90, lotSize: 475, strikeStep: 10, change: '-0.16%', isPositive: false, dayHigh: 1801.70, dayLow: 1785.00, iv: 0.220 }
];
